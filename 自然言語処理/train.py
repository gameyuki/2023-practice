...
from preprocessing import clean_html, normalize_number,tokenize, tokenize_base_from
...
def main():
    ...
    print('Base form .')
    train_and_eval(x_train,y_train,x_test,y_test,tokenize=tokenize_base_from)
